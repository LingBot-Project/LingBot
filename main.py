...
# API key by siuank
hypixel.setKeys(["37ffd511-3e8a-41be-a740-03e9b1509ca8"])  # , "2ca19e21-eb6d-4aaa-9ceb-91f4718c8bd9"
...
CACHE_MESSAGE = []
BANCHECK_UID = {}
WSURL = SERVER_ADDR + ":5701"
HTTPURL = SERVER_ADDR + ":5700"
...
ANTI_AD = r"送福利|定制水影|魔改水影|加群.*[0-9]{5,10}|.*内部|\n元|破甲|天花板|工具箱|绕.*更新|绕.*实名|开端|不封号|外部|.* toolbox|替换au|绕过(盒子)vape检测|内部|防封|封号|waibu|外部|.*公益|晋商|禁商|盒子更新后|小号机|群.*[0-9]{5,10}|\d{2,4}红利项目|躺赚|咨询(\+)|捡钱(模式)|(个人)创业|带价私聊|出.*号|裙.*[0-9]{5,10}|君羊.*[0-9]{5,10}|q(\:)[0-9]{5,10}|(限时)免费(获取)|.*launcher|3xl?top|.*小卖铺|cpd(d)|暴打|对刀|不服|稳定奔放|qq[0-9]{5,10}|定制.*|小卖铺|老婆不在家(刺激)|代购.*|出.*|vape"
