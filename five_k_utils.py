#coding=utf-8
# Thanks for https://github.com/SAGIRI-kawaii/saya_plugins_collection/blob/master/modules/5000zhao/utils.py
...
def genImage(word_a="5000兆円", word_b="欲しい!", default_width=1500, height=500,
    ...
    alpha = (0, 0, 0, 0)
    leftmargin = 50
    font_upper = ImageFont.truetype("./5k_fonts/STKAITI.TTF", _round(height/3))
    font_downer = ImageFont.truetype("./5k_fonts/STKAITI.TTF", _round(height/3))
